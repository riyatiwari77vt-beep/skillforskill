    ...
    db.serialize(() => {
        ...
        db.run(`
            CREATE TABLE IF NOT EXISTS users (
                ...
                skills_taught_count INTEGER DEFAULT 45,
                hours_learned INTEGER DEFAULT 78,
                achievements TEXT,
...
function runMigrations() {
    const columns = [
        ...
        { name: 'skills_taught_count', type: "INTEGER DEFAULT 45" },
        { name: 'hours_learned', type: "INTEGER DEFAULT 78" },
